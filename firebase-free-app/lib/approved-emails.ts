// Emails explicitly approved by the administrator. Anyone signing in with one of
// these gets a default Watcher account automatically; anyone else is denied.
// Keep this in sync with the mirrored list in firestore.rules.

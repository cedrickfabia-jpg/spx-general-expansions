...
export const FORM_FIELDS: FormFieldConfig[] = [
  ...
  { key: "escalationYears", label: "Escalation Years", section: "Request Details", type: "text", required: true, placeholder: "x years" },
  { key: "escalationRate", label: "Escalation Rate (%)", section: "Request Details", type: "text", required: true, placeholder: "xx.xx%" },
